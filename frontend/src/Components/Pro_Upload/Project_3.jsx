...
export default function Project_3()
{
    return(
        <>
            ...
            <div className="progress-bar flex-row justify-content-around" role="progressbar" style={{width: '100%'}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
            ...
            <div className="d-flex flex-row-reverse  mt-3 " >
                        <div className="w-25">
                        <button type="submit" className="btn btn-primary m-auto ">Finish</button>
