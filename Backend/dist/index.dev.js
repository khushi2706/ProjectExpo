...
var uploadProjectRoute = require("./routes/uploadProjectRoute");

var downloadProjectRoute = require("./routes/downloadProjectRoute"); //create the app
...
app.use('/api/downloadProject', downloadProjectRoute); //define port
