...
var AddProjectLink = function AddProjectLink(req, res, next) {
  var _req$body2, ProjectLink, ProjectId;

  return regeneratorRuntime.async(function AddProjectLink$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          res.set('Access-Control-Allow-Origin', '*');
          _req$body2 = req.body, ProjectLink = _req$body2.ProjectLink, ProjectId = _req$body2.ProjectId;
